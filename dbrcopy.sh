...
#copy DBRs from the s3 bucket they are stored in (billingbucket)
aws s3 cp s3://billingbucket/ . --exclude "*" --include "*resources-and-tags-2015-10*" --recursive --region ap-southeast-2 #--profile temp-creds
